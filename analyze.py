...
#   python analyze.py ./accounts --folder
#         """
#     )
...
#     parser.add_argument("--folder", action="store_true", help="Analyze entire folder")

#     args = parser.parse_args()

#     # Analyze
#     if args.folder:
#         print(f"{Fore.CYAN}Folder analysis coming soon...")
#     else:
#         if os.path.exists(args.path):
#             analyze_file(args.path, args.json)
#         else:
#             print(f"{Fore.RED}File not found: {args.path}")
#             sys.exit(1)
